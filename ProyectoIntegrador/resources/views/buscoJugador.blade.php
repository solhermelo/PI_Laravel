...
@section('content')
  ...
  <div class="form-group">
    <label for="exampleFormControlInput1">Fecha del partido</label>
  ...
  <div class="form-group">
    ...
    <input class="form-control" id="exampleFormControlInput1" type="time" name="hora" value="">
  </div>
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect2">Tipo de futbol</label>
    <select multiple class="form-control" id="exampleFormControlSelect2" name="tipo de futbol">
